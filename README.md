...
Server-Side Validation: Robust schema validation using Joi to ensure data integrity.
Persistent Sessions: User sessions are stored using express-session and connect-mongo, allowing users to stay logged in even after the server restarts.
Flash Messaging: Provides users with success and error notifications using connect-flash.
Responsive UI: Fully responsive interface built using Bootstrap and EJS templating.
